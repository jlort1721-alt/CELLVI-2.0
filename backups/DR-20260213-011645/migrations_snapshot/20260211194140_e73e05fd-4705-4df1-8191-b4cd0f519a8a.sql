...
CREATE TYPE public.app_role AS ENUM ('super_admin', 'admin', 'manager', 'operator', 'driver', 'client', 'auditor');
...
-- 8. Trigger to auto-create profile and default role on signup
